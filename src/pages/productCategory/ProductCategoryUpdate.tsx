...
import {
  ...
  FindProductCategoryRequest,
} from "../../redux-saga/action/productCategoryAction";

export default function ProductCategoryUpdate(props: any) {
  const dispatch = useDispatch();
  const { prodCat } = useSelector((state: any) => state.productCategoryState);
        ...
        <div className="w-96 mx-auto bg-white rounded shadow border-slate-900">
          ...
          >
            <div className="py-4 px-8">
              ...
              <div className="mb-4">
                <button className="w-full mb-3 rounded-full py-1 px-24 bg-transparent text-slate-900 font-semibold border border-slate-900 hover:bg-slate-900 hover:text-white hover:border-transparent ">
                  Save
                </button>
                <button
