    ...
    <div>
      <Layout>
        {displayEdit ? (
          ...
          <OrderCreate setDisplay={setDisplay} setRefresh={setRefresh} />
        ) : (
          <div className="m-6 min-h-screen">
            <h1 className="text-center my-4 font-bold text-3xl">Order</h1>
            <button
                ...
                <tbody className="divide-y divide-gray-100 border-t border-gray-100">
                  {(orders || []).map((item: any) => (
                    <tr className="hover:bg-gray-50" key={item.id}>
                      ...
                      <td className="px-6 py-4">{item.user.id}</td>
                      <td className="px-6 py-4">{item.totalproduct}</td>
